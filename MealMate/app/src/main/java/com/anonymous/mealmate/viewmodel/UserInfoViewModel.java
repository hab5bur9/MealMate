...
public class UserInfoViewModel {
    ...
    private void setUserActivityCalories(double BenedictKcal,int activityRatio){
        ...
        switch (activityRatio){
            case  1:  ActivityKcal*=SEDENTARY ;  break;//거의없음

            case 2:   ActivityKcal*=LIGHT;  break;//가벼운 활동

            case 3:  ActivityKcal*=MODERATE; break;//보통

            case 4: ActivityKcal*=ACTIVE; break;//많이

            case 5:ActivityKcal*=VERYACTIVE; break;//매우 많이
        }
        kcal=ActivityKcal;
    }
    ...
    private void setUserPurposeCalories(double ActivityKcal,int purpose){
        ...
        switch (purpose){
            case 1:  PurposeKcal*=DIET; break;//다이어트 일 경우

            case 2:  PurposeKcal*=BULK;break;//벌크업일 경우

            case 3: PurposeKcal*=MAINTAIN; break;//유지,관리 일 경우
        }
        kcal=PurposeKcal;
    }
   ...
   /* private double calculateCalories(double height, double weight, String gender, int age, int activity, int purpose) {
    ...
    //활동량에 따른 칼로리 계산하기
    switch (activity){
        case  1:  kcal*=SEDENTARY ;  break;//거의없음

        case 2:   kcal*=LIGHT;  break;//가벼운 활동

        case 3:  kcal*=MODERATE; break;//보통

        case 4: kcal*=ACTIVE; break;//많이

        case 5:kcal*=VERYACTIVE; break;//매우 많이
    }
//목적에 따른 칼로리 계산하기
switch (purpose){
    case 1:  kcal*=DIET; break;//다이어트 일 경우

    case 2:  kcal*=BULK;break;//벌크업일 경우

    case 3: kcal*=MAINTAIN; break;//유지,관리 일 경우
    }
        return kcal;
    }*/
}
